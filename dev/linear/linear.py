...
configs = [
    triton.Config({"BLOCK_SIZE_T": BT, "BLOCK_SIZE_IN": BIN, "BLOCK_SIZE_OUT": BOUT}, num_warps=w) for BT in [16, 32, 64, 128] for BIN in [16, 32, 64, 128] for BOUT in [16, 32, 64, 128] for w in [2, 4, 8]
]
